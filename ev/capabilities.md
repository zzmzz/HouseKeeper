...
### ac_on · 打开空调（制冷降温）
何时：主人觉得热、想凉快。夏天说『有点热』『热死了』『凉快一下』都是这个——开空调制冷。
...
### humidifier_off · 关闭加湿器
何时：关掉加湿器、不用加湿了。
辨析：★和 humidifier_on 相反；问湿度多少是 humidity 查询，不是控制。
...
何时：在『询问、了解』空气或环境好不好。『空气怎么样』『现在适合开窗吗』『PM2.5多少』『外面雾霾大吗』。
辨析：★这是查询、不是执行。问湿度≠开加湿器；问空气怎么样≠开新风。
